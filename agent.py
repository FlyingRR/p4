...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            #self.epsilon = math.pow(0.75,self.trialNumber)
            #self.epsilon = math.pow(0.9,self.trialNumber)
            #self.epsilon = math.exp(-0.1*self.trialNumber)
            self.epsilon = math.cos(0.05*self.trialNumber)
    ...
    def build_state(self):
        ...
        state = str([waypoint,inputs['light'],inputs['oncoming']])
        if self.learning:
